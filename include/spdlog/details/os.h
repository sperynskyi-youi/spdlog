...
#elif defined(__FreeBSD__) && !defined(__ORBIS__) // <sys/thr.h> is missing on Orbis/PS4
...
#elif defined(__FreeBSD__) && !defined(__ORBIS__) // Orbis/PS4 does not have the thr_self() API
    long tid;
    thr_self(&tid);
